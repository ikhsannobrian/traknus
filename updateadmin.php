...
if (isset($_POST["ubah"])) {
    ...
    if ($_FILES["image"]["size"] > 0) {
        ...
        mysqli_query($conn, "UPDATE laporan SET nama ='$nama', departemen ='$departemen', kebutuhan='$kebutuhan', tanggal='$tanggal', penjelasan='$penjelasan', tgl_kerja='$tgl_kerja', jenis='$jenis',wkt_mulai='$wkt_mulai',wkt_akhir='$wkt_akhir', status ='$status', pekerja ='$pekerja', image='$image_name' WHERE id ='$_id'");
    } else {
