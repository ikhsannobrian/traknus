      ...
      <div class="row align-items-center justify-content-center h-100 g-0 px-4 px-sm-0">
        <div class="col col-sm-6 col-lg-7 col-xl-6">
          ...
          <div class="text-center">
            <h3 class="fw-bold">Form Target</h3>
            <p class="text-secondary">Makes some targets to achieve it</p>
          </div>
          <!-- Start Form -->
          <form method="post">
            <label for="">Nama Target</label>
            <div class="input-group mb-3">
              <input type="name" class="form-control form-control-lg fs-6" placeholder="Masukan nama target" name="nama_target" required />
            </div>
            <label for="">Periode</label>
            <div class="input-group mb-3">
              <input type="periode" class="form-control form-control-lg fs-6" placeholder="Masukan tahun periode" name="periode" required />
            </div>
            <label for="">Tanggal Mulai</label>
            <div>
              <input type="date" class="form-control form-control-lg fs-6 mb-3" name="tgl_mulai" />
            </div>
            <div class="mb-3">
